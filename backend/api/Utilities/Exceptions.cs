namespace Api.Utilities
{
    ...
    public class InspectionGroupNotFoundException(string message) : Exception(message) { }
    ...
    public class InspectionGroupExistsException(string message) : Exception(message) { }
