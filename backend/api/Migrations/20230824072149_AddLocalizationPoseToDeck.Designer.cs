...
namespace Api.Migrations
{
    ...
    [Migration("20230824072149_AddLocalizationPoseToDeck")]
    partial class AddLocalizationPoseToDeck
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Database.Models.Area", b =>
                {
                    ...
                    b.Property<string>("LocalizationPoseId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Api.Database.Models.LocalizationPose", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Api.Database.Models.Area", b =>
                {
                    ...
                    b.HasOne("Api.Database.Models.LocalizationPose", "LocalizationPose")
                        .WithMany()
                        .HasForeignKey("LocalizationPoseId");
            ...
            modelBuilder.Entity("Api.Database.Models.LocalizationPose", b =>
                {
                    b.OwnsOne("Api.Database.Models.Pose", "Pose", b1 =>
                        {
                            b1.Property<string>("LocalizationPoseId")
                                .HasColumnType("nvarchar(450)");

                            b1.HasKey("LocalizationPoseId");

                            b1.ToTable("LocalizationPoses");
                            ...
                            b1.OwnsOne("Api.Database.Models.Orientation", "Orientation", b2 =>
                                {
                                    b2.Property<string>("PoseLocalizationPoseId")
                                        .HasColumnType("nvarchar(450)");
                                    ...
                                    b2.HasKey("PoseLocalizationPoseId");

                                    b2.ToTable("LocalizationPoses");

                                    b2.WithOwner()
                                        .HasForeignKey("PoseLocalizationPoseId");
                                });
