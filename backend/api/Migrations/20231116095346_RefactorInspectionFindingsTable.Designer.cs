...
namespace Api.Migrations
{
    ...
    [Migration("20231116095346_RefactorInspectionFindingsTable")]
    partial class RefactorInspectionFindingsTable
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("Api.Database.Models.InspectionFinding", "InspectionFindings", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("InspectionDate")
                                .HasColumnType("timestamp with time zone");

                            b1.Property<string>("InspectionId")
                                .HasColumnType("text");

                            b1.Property<string>("IsarStepId")
                                .IsRequired()
                                .HasColumnType("text");
