...
namespace Api.Migrations
{
    ...
    [Migration("20260819121426_MakeAnalysisTypeNonNullable")]
    partial class MakeAnalysisTypeNonNullable
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("Api.Database.Models.AcousticInspectionMetadata", "AcousticInspectionMetadata", b1 =>
                        {
                            ...
                            b1.OwnsOne("Api.Database.Models.Roi", "Roi", b2 =>
                                {
                                    b2.Property<string>("AcousticInspectionMetadataMissionTaskId")
                                        .HasColumnType("text");
                                    ...
                                    b2.HasKey("AcousticInspectionMetadataMissionTaskId");

                                    b2.ToTable("MissionTasks");

                                    b2.WithOwner()
                                        .HasForeignKey("AcousticInspectionMetadataMissionTaskId");
                                });
