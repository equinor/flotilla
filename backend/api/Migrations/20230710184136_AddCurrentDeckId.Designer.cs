...
namespace Api.Migrations
{
    ...
    [Migration("20230710184136_AddCurrentDeckId")]
    partial class AddCurrentDeckId
    {
                    ...
                    b.OwnsOne("Api.Database.Models.MapMetadata", "MapMetadata", b1 =>
                        {
                            ...
                            b1.OwnsOne("Api.Database.Models.Boundary", "Boundary", b2 =>
                                {
                                    b2.Property<string>("MapMetadataMissionId")
                                        .HasColumnType("nvarchar(450)");
                                    ...
                                    b2.HasKey("MapMetadataMissionId");

                                    b2.ToTable("Missions");

                                    b2.WithOwner()
                                        .HasForeignKey("MapMetadataMissionId");
                                });
