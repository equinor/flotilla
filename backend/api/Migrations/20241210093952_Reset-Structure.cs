    ...
    public partial class ResetStructure : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    IsarTaskId = table.Column<string>(
                    ...
                    InspectionUrl = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstallationCode = table.Column<string>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BatteryMissionStartThreshold = table.Column<float>(
                        type: "real",
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    InspectionDate = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MapMetadata_MapName = table.Column<string>(
                        type: "character varying(200)",
                        maxLength: 200,
                        nullable: false
                    ),
                    MapMetadata_Boundary_X1 = table.Column<double>(
                        type: "double precision",
                        nullable: false
                    ),
                    MapMetadata_Boundary_X2 = table.Column<double>(
                        type: "double precision",
                        nullable: false
                    ),
                    MapMetadata_Boundary_Y1 = table.Column<double>(
                        type: "double precision",
                        nullable: false
                    ),
                    MapMetadata_Boundary_Y2 = table.Column<double>(
                        type: "double precision",
                        nullable: false
                    ),
                    MapMetadata_Boundary_Z1 = table.Column<double>(
                        type: "double precision",
                        nullable: false
                    ),
                    MapMetadata_Boundary_Z2 = table.Column<double>(
                        type: "double precision",
                        nullable: false
                    ),
                    MapMetadata_TransformationMatrices_C1 = table.Column<double>(
                        type: "double precision",
                        nullable: false
                    ),
                    MapMetadata_TransformationMatrices_C2 = table.Column<double>(
                        type: "double precision",
                        nullable: false
                    ),
                    MapMetadata_TransformationMatrices_D1 = table.Column<double>(
                        type: "double precision",
                        nullable: false
                    ),
                    MapMetadata_TransformationMatrices_D2 = table.Column<double>(
                        type: "double precision",
                        nullable: false
                    ),
                    DefaultLocalizationPoseId = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesiredStartTime = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    RobotId = table.Column<string>(type: "text", nullable: false),
                    ...
                    Map_MapName = table.Column<string>(
                        type: "character varying(200)",
                        maxLength: 200,
                        nullable: true
                    ),
                    Map_Boundary_X1 = table.Column<double>(
                        type: "double precision",
                        nullable: true
                    ),
                    Map_Boundary_X2 = table.Column<double>(
                        type: "double precision",
                        nullable: true
                    ),
                    Map_Boundary_Y1 = table.Column<double>(
                        type: "double precision",
                        nullable: true
                    ),
                    Map_Boundary_Y2 = table.Column<double>(
                        type: "double precision",
                        nullable: true
                    ),
                    Map_Boundary_Z1 = table.Column<double>(
                        type: "double precision",
                        nullable: true
                    ),
                    Map_Boundary_Z2 = table.Column<double>(
                        type: "double precision",
                        nullable: true
                    ),
                    Map_TransformationMatrices_C1 = table.Column<double>(
                        type: "double precision",
                        nullable: true
                    ),
                    Map_TransformationMatrices_C2 = table.Column<double>(
                        type: "double precision",
                        nullable: true
                    ),
                    Map_TransformationMatrices_D1 = table.Column<double>(
                        type: "double precision",
                        nullable: true
                    ),
                    Map_TransformationMatrices_D2 = table.Column<double>(
                        type: "double precision",
                        nullable: true
                    ),
                    StartTime = table.Column<DateTime>(
            ...
            migrationBuilder.CreateIndex(name: "IX_Areas_DeckId", table: "Areas", column: "DeckId");
        ...
        {
            migrationBuilder.DropTable(name: "AccessRoles");

            migrationBuilder.DropTable(name: "DocumentInfo");

            migrationBuilder.DropTable(name: "InspectionFindings");

            migrationBuilder.DropTable(name: "MissionDefinitions");

            migrationBuilder.DropTable(name: "MissionTasks");

            migrationBuilder.DropTable(name: "RobotBatteryTimeseries");

            migrationBuilder.DropTable(name: "RobotPoseTimeseries");

            migrationBuilder.DropTable(name: "RobotPressureTimeseries");
            ...
            migrationBuilder.DropTable(name: "MissionRuns");
            ...
            migrationBuilder.DropTable(name: "DefaultLocalizationPoses");
