...
namespace Api.Migrations
{
    ...
    [Migration("20241206133154_AddEchoTagTable")]
    partial class AddEchoTagTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Services.MissionLoaders.EchoTagInspectionMetadata", b =>
                {
                    b.Property<string>("TagId")
                        .HasColumnType("text");
                    ...
                    b.ToTable("EchoTagInspectionMetadata");
                });
            ...
            modelBuilder.Entity("Api.Services.MissionLoaders.EchoTagInspectionMetadata", b =>
                {
                    b.OwnsOne("Api.Services.Models.IsarZoomDescription", "ZoomDescription", b1 =>
                        {
                            b1.Property<string>("EchoTagInspectionMetadataTagId")
                                .HasColumnType("text");
                            ...
                            b1.HasKey("EchoTagInspectionMetadataTagId");

                            b1.ToTable("EchoTagInspectionMetadata");

                            b1.WithOwner()
                                .HasForeignKey("EchoTagInspectionMetadataTagId");
                        });
