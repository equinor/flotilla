    ...
    ) : IAreaService
    {
        ...
        public async Task<IEnumerable<Area?>> ReadByDeckId(string deckId, bool readOnly = true)
        {
            ...
            return await GetAreas(readOnly: readOnly)
                .Where(a => a.Deck != null && a.Deck.Id.Equals(deckId))
                .ToListAsync();
        }
        ...
        public async Task<Area> Create(CreateAreaQuery newAreaQuery)
        {
            ...
            var deck =
                await deckService.ReadByInstallationAndPlantAndName(
                    installation,
                    plant,
                ...
                ?? throw new DeckNotFoundException(
                    $"No deck with name {newAreaQuery.DeckName} could be found"
                );
        ...
        public async Task<Area?> ReadByInstallationAndPlantAndDeckAndName(
            Installation installation,
            Plant plant,
            Deck deck,
            string areaName,
        ...
        )
        {
            Expression<Func<Area, bool>> installationFilter = string.IsNullOrEmpty(
                ...
                : area =>
                    ...
                    && area.Deck.Plant.Installation.InstallationCode.ToLower()
                        .Equals(parameters.InstallationCode.ToLower().Trim());

            Expression<Func<Area, bool>> deckFilter = area =>
                string.IsNullOrEmpty(parameters.Deck)
                || (
                    area.Deck != null
                    && area.Deck.Name != null
        ...
        public void DetachTracking(Area area)
        {
            ...
            if (area.Deck != null)
                deckService.DetachTracking(area.Deck);
