...
namespace Api.Services
{
    public interface IExclusionAreaService
    {
        ...
        public Task<IEnumerable<ExclusionArea>> ReadByInstallation(
        ...
        public Task<List<ExclusionArea>> ReadExclusionAreasByInstallation(
            string installationCode,
            bool readOnly = true
        );
    ...
    ) : IExclusionAreaService
    {
        ...
        public async Task<IEnumerable<ExclusionArea>> ReadByInstallation(
            string installationCode,
            bool readOnly = true
        )
        {
        ...
        public async Task<List<ExclusionArea>> ReadExclusionAreasByInstallation(
            string installationCode,
            bool readOnly = true
        )
        {
        ...
        {
            var exclusionAreas = await ReadByInstallation(installationCode);
