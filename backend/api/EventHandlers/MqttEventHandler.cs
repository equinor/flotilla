...
namespace Api.EventHandlers
{
    ...
    public class MqttEventHandler : EventHandlerBase
    {
        ...
        private async void OnIsarStatus(object? sender, MqttReceivedArgs mqttArgs)
        {
            ...
            {
                _logger.LogInformation("Robot {robotName} received a new isar robot status {isarStatus}, but the robot status was already the same", robot.Name, isarStatus.Status);
                return;
            }
