...
const FetchingMissionsDialog = ({ closeDialog }: { closeDialog: () => void }) => {
...
const NoMissionsDialog = ({ closeDialog }: { closeDialog: () => void }) => {
    const { TranslateText } = useLanguageContext()
    return (
        <StyledMissionDialog>
...
const SelectAndScheduleMissionsDialog = ({ echoMissions, closeDialog, setLoadingMissionSet }: ScheduleDialogProps) => {
    const { TranslateText } = useLanguageContext()
