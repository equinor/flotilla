...
export class Robot {
    ...
    constructor(robotInfo: RobotInfo, battery: number, pose: Pose, status: RobotStatus) {
...
export const defaultRobots: { [name: string]: Robot } = {
    ...
    exRobotics: new Robot(exRobotInfo, 59, defaultPose, RobotStatus.MissionInProgress),
